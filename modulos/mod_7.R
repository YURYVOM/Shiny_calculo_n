...
"# La tabla final exportada en la app fue:\n",
"tabla_final <- ", paste(capture.output(dput(tabla_salida_final())), collapse = "\n"), "\n\n",
"print(tabla_final)\n"
      )
    })
